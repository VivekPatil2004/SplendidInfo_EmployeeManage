      ...
      try {
        ...
        if (employee) {
          setForm({
            ...
            performanceRating: employee.performanceRating?.toString() || "4",
      ...
      <div className="w-full max-w-4xl">
        <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h1 className="text-3xl font-extrabold tracking-tight text-slate-800">Edit Profile</h1>
              <p className="text-sm text-slate-500 font-medium mt-1">Update all database fields for this employee.</p>
            </div>
          </div>
          <div className="h-12 w-12 rounded-2xl border-4 border-white bg-slate-50 flex items-center justify-center text-xl font-bold text-slate-500 shadow-md">
